...
list.dirs(path = "./Workflows/")
workflowFiles <- "./Workflows/tg-wdl-unpairedVariantCaller/aws/"
```
...
womtoolValidate(paste0(workflowFiles, "unpaired-trio-variantcaller-aws.wdl"))

thisJob <- cromwellSubmitBatch(
  WDL = paste0(workflowFiles, "unpaired-trio-variantcaller-aws.wdl"),
  Batch = paste0(workflowFiles, "unpaired-trio-variantcaller-aws-batch.json"),
  Params = paste0(workflowFiles, "unpaired-trio-variantcaller-aws-parameters.json"),
  Options = paste0(workflowDir, "aws-options.json"),
...
### Gizmo workflow
```{r}
workflowFiles <- "./Workflows/tg-wdl-unpairedVariantCaller/gizmo/"
list.files(path = workflowFiles)
